    ...
    <div class="container-fluid py-1 px-2">
      ...
      <div class="collapse navbar-collapse mt-sm-0 mt-2 px-0" id="navbar">
        ...
        <ul class="navbar-nav me-auto ms-0 justify-content-end">
          ...
          <li class="nav-item dropdown ps-0 d-flex align-items-center">
            ...
            <ul class="dropdown-menu  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
              <li class="mb-2">
                <a class="dropdown-item border-radius-md" href="javascript:;">
                  <div class="d-flex py-1">
                    <div class="my-auto">
                      <img src="" class="avatar avatar-sm border-radius-sm  ms-3 ">
                    </div>
              ...
              <li class="mb-2">
                <a class="dropdown-item border-radius-md" href="javascript:;">
                  <div class="d-flex py-1">
                    <div class="my-auto">
                      <img src="../assets/img/small-logos/logo-google.svg" class="avatar avatar-sm border-radius-sm bg-gradient-dark p-2  ms-3 ">
                    </div>
                    <div class="d-flex flex-column justify-content-center">
                      <h6 class="text-sm font-weight-normal mb-1">
      ...
      <div class="col-md-12">
        <div class="d-md-flex align-items-center mb-3">
          <div class="mb-md-0 mb-3">
            ...
            @endif
            <p class="mb-0">بطل كسل وكمل المشروع !</p>
          </div>
          <button
            type="button"
