<aside
      class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-end rotate-caret"
      id="sidenav-main"
    >
      <div class="sidenav-header">
        <i
          class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute start-0 top-0 d-none d-xl-none"
          aria-hidden="true"
          id="iconSidenav"
        ></i>
        <a
      ...
      <div
        class="collapse navbar-collapse px-4 px-0 w-auto"
        id="sidenav-collapse-main"
      >
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class=" nav-link {{request()->routeIs('Main') ? 'active' : '' }}"  href="{{route('Main')}}"  wire:navigate>
              <div 
          ...
          <li class="nav-item">
            <a class=" nav-link {{request()->routeIs('users') || request()->routeIs('users-form') ? 'active' : '' }}" href="{{route('users')}}"  wire:navigate>
              <div
                class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class=" nav-link {{request()->routeIs('org') ? 'active' : '' }}" href="{{route('org')}}" wire:navigate>
          ...
          <li class="nav-item">
            <a class=" nav-link {{request()->routeIs('logs') ? 'active' : '' }}" href="{{route('logs')}}"  wire:navigate>
              <div
                class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center"
              >
                <svg
          ...
          <li class="nav-item">
            <a class=" nav-link {{request()->routeIs('role')|| request()->routeIs('role-form') ? 'active' : '' }}" href="{{route('role')}}" wire:navigate>
              <div class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
          ...
          <li class="nav-item mt-2">
            <div class="d-flex align-items-center nav-link">
              ...
              <span class="text-white font-weight-normal text-md me-2"
                >صفحات الحساب</span
              >
            </div>
          </li>
        ...
        <div class="card border-radius-md" id="sidenavCard">
          <div class="card-body text-end p-3 w-100">
            ...
            <div class="docs-info">
              ...
              <a
                href="#"
                class="font-weight-bold text-sm mb-0 icon-move-left mt-auto w-100 mb-0"
                >توثيق
                <i
                  class="fas fa-arrow-left-long text-sm me-1"
                  aria-hidden="true"
                ></i>
              </a>
            </div>
