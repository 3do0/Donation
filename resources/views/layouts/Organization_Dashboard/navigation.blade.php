<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-end rotate-caret w-80"
    ...
    <div class="collapse navbar-collapse px-4 px-0" id="sidenav-collapse-main">
        <ul class="navbar-nav w-95">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between align-items-center {{ request()->routeIs('organization.project-accpected') || request()->routeIs('organization.completed-project-table') || request()->routeIs('organization.completed-project-card') ? '' : 'collapsed' }}"
                   data-bs-toggle="collapse"
                   href="#sidebarProjects"
                   role="button"
                   aria-expanded="{{ request()->routeIs('organization.project-accpected') || request()->routeIs('organization.completed-project-table') || request()->routeIs('organization.completed-project-card') ? 'true' : 'false' }}"
                ...
                <div class="collapse {{ request()->routeIs('organization.project-accpected') || request()->routeIs('organization.completed-project-table') || request()->routeIs('organization.completed-project-card') ? 'show' : '' }}"
                     id="sidebarProjects">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link fw-bold d-flex align-items-center mb-2 menu-dot-right {{ request()->routeIs('organization.project-accpected') ? 'active text-warning' : 'text-light' }}"
                               href="{{ route('organization.project-accpected') }}" wire:navigate>
            ...
            <li class="nav-item">
                <a class=" nav-link {{ request()->routeIs('organization.projects-requests-form') ? 'active' : '' }}" href="{{ route('organization.projects-requests-form') }}"
                    wire:navigate>
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
