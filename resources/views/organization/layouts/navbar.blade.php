        ...
        <ul class="navbar-item flex-row ml-auto">
            ...
            <li class="nav-item">
                <form method="POST" action="{{ route('theme.toggle') }}">
                    @csrf
                    <button type="submit" class="nav-link me-5 ms-5 bg-transparent" style="width:24px; height: 24px;  padding: 0; border: none; ">
                        <!-- تغيير الأيقونة بناءً على الثيم الحالي -->
                        @if($theme == 'light')
                            <i class="bi bi-moon "></i>  <!-- أيقونة القمر عندما يكون الثيم فاتح -->
                        @else
                            <i class="bi bi-sun text-white"></i>  <!-- أيقونة الشمس عندما يكون الثيم داكن -->
                        @endif
                    </button>
                </form>
            </li>
            ...
            <li class="nav-item dropdown language-dropdown">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="{{asset('assets/img/ye.png')}}" class="flag-width" alt="flag">
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('assets/img/ye.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;العربية</span></a>
                ...
                <div class="dropdown-menu position-absolute e-animated e-fadeInUp" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">                            
                        <div class="media mx-auto">
                            ...
                            <img src="{{ asset('storage/'.auth()->user()->photo) }}" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body">
