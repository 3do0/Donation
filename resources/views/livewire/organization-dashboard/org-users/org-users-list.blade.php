        ...
        <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0 bg-dark">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h4 class="font-weight-semibold mb-0 text-white">حسابات المنظمة</h4>
                        <p class="text-sm text-light">قائمة بالحسابات الفعالة للمنظمة</p>
                    </div>
                    <div class=" d-flex gap-2">
                        ...
                        <a type="button"
                            ...
                            href="{{ route('organization.users-form') }}" wire:navigate>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead class="bg-gray-100">
                            <tr>
                                ...
                                <th class="text-secondary text-xs font-weight-semibold opacity-7">المستخدم</th>
                                <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">الجنس
                                </th>
                                <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">الحالة
                                </th>
                                <th class="text-center text-secondary text-xs font-weight-semibold opacity-7">تاريخ
                                    الانشاء</th>
                                </th>
                                <th class="text-secondary text-xs font-weight-semibold opacity-7">العمليات</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($users as $user)
                                <tr data-status="{{ $user->is_online ? 'online' : 'offline' }}">
                                    ...
                                    <td class="text-center">
                                        <p class="text-sm text-dark font-weight-semibold mb-0">{{ $user->gender ?? 'غير محدد' }}</p>
                                        {{-- <p class="text-sm text-secondary mb-0">{{$user->gender}}</p> --}}
                                    </td>
                                    ...
                                    <td class="align-middle text-center">
                                        <span
                                            class="text-secondary text-sm font-weight-normal">{{ $user->created_at->format('Y-m-d') }}</span>
                                    </td>
