<div class="modal fade" id="createProjectModal" tabindex="-1" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true"
    wire:ignore.self>
    <div class="modal-dialog  modal-xl " style="max-width: 120vh;transform: translateX(-70px)">
        ...
        <div class="modal-content">
            <div class="modal-header  bg-dark d-flex justify-content-between">
                <h5 class="modal-title text-white flex-grow-1">تسجيل المشاريع</h5>
...
<script>
    document.addEventListener('ProjectCreated', () => {
        ...
        if (modal && modal._isShown) { // تحقق إذا كان المودال مفتوحًا
