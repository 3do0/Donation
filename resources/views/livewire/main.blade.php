          ...
          <div>
            ...
            >
              <div
                ...
                style="background-image: url('../assets/img/cases-images/11.jpg')"
              ></div>
              <div class="card-body text-start px-0 py-0 w-100 ">
                <div class="row mt-12 bg-dark px-3">
                  <div class="col-3 mt-auto text-end">
                    ...
                    <p
                      class="text-light text-xs font-weight-bolder mb-0">
                      اسم
                    </p>
                    <h5 class="text-white font-weight-bolder">مؤمن</h5>
                  </div>
        ...
        <div class="swiper-slide">
          <div>
            ...
            >
              <div
                class="full-background bg-cover"
                style="background-image: url('../assets/img/cases-images/44.jpg')"
              ></div>
              <div class="card-body text-start px-0 py-0 w-100 ">
                <div class="row mt-12 bg-dark px-3">
                  <div class="col-3 mt-auto text-end">
        ...
        <div class="swiper-slide">
          <div>
            ...
            >
              <div
                class="full-background bg-cover"
                style="background-image: url('../assets/img/cases-images/3333.png')"
              ></div>
              <div class="card-body text-start px-0 py-0 w-100 ">
                <div class="row mt-12 bg-dark px-3">
                  <div class="col-3 mt-auto text-end">
    ...
    <div class="col-lg-4 col-md-6 mb-md-0 mb-4">
      <div class="card shadow-xs border h-100">
        ...
        <div class="card-body py-3">
          ...
          <button class="btn btn-white position-absolute">
            عرض التقرير
          </button>
        </div>
      </div>
        ...
        <div class="card-header border-bottom pb-0">
          <div class="d-flex align-items-center mb-3">
            ...
            <div class="me-auto d-flex">
              <button
                type="button"
                class="btn btn-sm btn-white mb-0 ms-2"
              >
                عرض التقرير
              </button>
              <button
          ...
          <div class="pb-3 d-flex align-items-center">
            ...
            >
              <button
                type="button"
                class="btn btn-white px-3 mb-0 active"
              >
                مشاهدة الكل
              </button>
              <button type="button" class="btn btn-white px-3 mb-0">
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2">
                      <div
                        class="avatar avatar-sm rounded-circle bg-gray-100 ms-2 my-2"
                      >
                        <img
