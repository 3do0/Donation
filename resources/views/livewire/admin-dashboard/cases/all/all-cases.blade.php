                        ...
                        <table id="style-1" class="table style-1">
                            <thead>
                                <tr class="text-nowrap">
                                    ...
                                    <th class="text-center custom-btn-color">تمت الموافقة بواسطة</th>
                            ...
                            <tbody>
                                @foreach ($allcases as $case)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $case->target_amount }}</td>
                                        <td class="text-center">{{ $case->raised_amount }}</td>
                                        <td class="text-center">{{  max($case->target_amount - $case->raised_amount, 0) }}</td>
